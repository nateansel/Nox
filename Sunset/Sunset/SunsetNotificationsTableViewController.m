//
//  SunsetNotificationsTableViewController.m
//  Sunset
//
...
#import "SunsetNotificationsTableViewController.h"

@implementation SunsetNotificationsTableViewController
...
- (void)addOrDeleteRows {
  ...
  [myDefaults setObject:tableData forKey:@"sunsetNotificationsArray"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
  ...
  NSDate *nextSunset = [[[myDefaults objectForKey:@"upcomingSunsets"] objectAtIndex:0] dateByAddingTimeInterval:((minutes + hours * 60) * -60)];
  cell.detailTextLabel.text = [dateFormatter stringFromDate:nextSunset];
